...
> Nuovo: flusso AI Meal Photo a due step (`analyzeMealPhoto` → `confirmMealPhoto`) documentato in `backend/docs/ai_meal_photo.md` per distinguere suggerimento AI e commit nutrizionale.
