#!/usr/bin/env python3
"""
Nutrifit User MCP Server - HTTP Mode
...
# FastAPI app
app = FastAPI(
    title="Nutrifit User MCP Server",
    description="HTTP MCP server for user management and authentication",
    version="1.0.0",
)
...
TOOL_REGISTRY = {
    ...
    "authenticate_or_create": authenticate_or_create,
...
if __name__ == "__main__":
    print(f"🚀 Starting Nutrifit User MCP Server (HTTP)")
