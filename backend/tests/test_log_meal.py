...
@pytest.mark.asyncio
async def test_log_meal_basic() -> None:
    mutation = _minify(
        """
        mutation {
...
@pytest.mark.asyncio
async def test_log_meal_idempotent() -> None:
    mutation = _minify(
...
@pytest.mark.asyncio
async def test_log_meal_invalid_quantity() -> None:
...
@pytest.mark.asyncio
async def test_log_meal_with_explicit_idempotency_key() -> None:
    mutation = _minify(
