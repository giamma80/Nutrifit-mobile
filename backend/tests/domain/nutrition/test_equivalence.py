...
from rules.category_profiles import (
    ...
    apply_category_profile as legacy_apply_category,
...
class TestNutritionCalculationEquivalence:
    ...
    def test_bmr_calculation_mifflin_st_jeor(self):
        """Test BMR calculation matches standard Mifflin-St Jeor."""
    ...
    def test_tdee_calculation_activity_multipliers(self):
        """Test TDEE multipliers match standard values."""
    ...
    def test_macro_targets_calorie_distribution(self):
        """Test macro distribution matches nutrition science."""
    ...
    def test_recompute_calories_equivalence(self):
        """Test recompute calories matches legacy function."""
...
class TestCategoryProfileEquivalence:
    """Test category profile adapter vs legacy rules/category_profiles.py."""
    
    def setup_method(self):
        self.adapter = CategoryProfileAdapter()
    
    def test_category_classification_equivalence(self):
        """Test food classification matches legacy TOKEN_MAP."""
        ...
        test_cases = [
            ...
            ("patate arrosto", "tuber"),
            ("insalata mista", "leafy_salad"),
            ("latte intero", "dairy_basic"),
            ("limone spremuto", "citrus_garnish"),
            ("basilico fresco", "herb"),
            ("bistecca manzo", None),  # Not in categories
        ]
        
        for food_label, expected_category in test_cases:
            result = self.adapter.classify_food(food_label)
            assert result == expected_category
    
    def test_garnish_clamp_equivalence(self):
        """Test garnish clamping matches legacy function."""
    ...
    def test_category_profiles_data_equivalence(self):
        """Test category profile nutrients match legacy CATEGORY_PROFILES."""
...
class TestDailySummaryEquivalence:
    ...
    def test_daily_summary_deficit_calculation(self):
        """Test deficit calculation matches app.py logic."""
        
        # Mock data
        self.meal_data_port.get_daily_meals.return_value = [
            {"calories": 300}, {"calories": 450}, {"calories": 350}
        ]
    ...
    def test_daily_summary_edge_cases(self):
        """Test edge cases: zero calories out, surplus, etc."""
